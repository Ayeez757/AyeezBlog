...
INSERT INTO friend_link_class (id, class_name, class_desc, sort, created_at, updated_at)
VALUES
    (1, '1.特别关心', '常联系的朋友~~', 1, NOW(), NOW());

INSERT INTO friend_link (id, class_id, name, link, avatar, descr, rss, sort, created_at, updated_at)
VALUES
    (1, 1, '阿叶Ayeez的博客', 'https://blog.ayeez.cn/', 'https://qiniu.ayeez.cn/avatar.jpg', '记录学习历程，记录美好生活', NULL, 1, NOW(), NOW());
